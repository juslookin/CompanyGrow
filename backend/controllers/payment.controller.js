...
const approveBadges = async (req, res) => {
  ...
  try {
    ...
    console.log('🔍 Debug - approveBadges called');
    console.log('🔍 Debug - employeeId:', employeeId);
    console.log('🔍 Debug - badgeIds:', badgeIds);
...
const getSessionDetails = async (req, res) => {
  try {
    ...
    console.log('🔍 Backend - Session retrieved successfully');
    console.log('🔍 Backend - Session ID:', session.id);
    console.log('🔍 Backend - Session metadata:', session.metadata);
    console.log('🔍 Backend - badgeIds in metadata:', session.metadata?.badgeIds);
    res.json(session);
  } catch (error) {
